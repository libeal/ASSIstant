#!/usr/bin/env python3
"""Frozen pre-2026 MCP compatibility client used by the Bash agent.

This module preserves the project's 2025-era wire behavior for explicit
fallback. It receives security fixes only; new protocol features belong in
mcp_client.py and the official SDK adapter.
"""
